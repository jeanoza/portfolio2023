...
export default function Footer() {
  return (
    <footer className="footer items-center p-4 bg-base-300 text-base-content mt-4">
      ...
      <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <Link
          href="https://www.github.com/jeanoza"
          target="_blank"
        ...
        <Link
          href="https://www.linkedin.com/in/kyubong-choi-489198176/"
          target="_blank"
          className="fill-current hover:fill-primary"
        >
          <svg
